...
| <a name="input_runtime_environment_bindings"></a> [runtime\_environment\_bindings](#input\_runtime\_environment\_bindings) | Runtime environment variables resolved from resources in this invocation. Values are memory\_id or browser\_id. | `map(string)` | `{}` | no |
