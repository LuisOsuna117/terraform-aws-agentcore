...
| <a name="input_runtime_invoke_arns"></a> [runtime\_invoke\_arns](#input\_runtime\_invoke\_arns) | Additional AgentCore Runtime ARNs the module-created Gateway role may invoke. HTTP Runtime target ARNs are inferred automatically. | `list(string)` | `[]` | no |
