...
| <a name="input_iam_principals"></a> [iam\_principals](#input\_iam\_principals) | Optional IAM principal ARNs matched by this rule. | `set(string)` | `[]` | no |
| <a name="input_paths"></a> [paths](#input\_paths) | Request paths matched by this rule. | `list(string)` | n/a | yes |
